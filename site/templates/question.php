  ...
  <?php switch($question):
    case "1": ?>
      <div class="question question_page" id="question1">
        1.<br><br><?= page('home')->q1_de() ?><br><br><?= page('home')->q1_en() ?>
      </div>
    <?php break; ?>
    <?php case "2": ?>
      <div class="question question_page" id="question2">
        2.<br><br><?= page('home')->q2_de() ?><br><br><?= page('home')->q2_en() ?>
      </div>
    <?php break; ?>
    <?php case "3": ?>
      <div class="question question_page" id="question3">
        3.<br><br><?= page('home')->q3_de() ?><br><br><?= page('home')->q3_en() ?>
      </div>
    <?php break; ?>
    <?php case "4": ?>
      <div class="question question_page" id="question4">
        4.<br><br><?= page('home')->q4_de() ?><br><br><?= page('home')->q4_en() ?>
      </div>
    <?php break; ?>
    <?php case "5": ?>
      <div class="question question_page" id="question5">
        5.<br><br><?= page('home')->q5_de() ?><br><br><?= page('home')->q5_en() ?>
      </div>
    <?php break; ?>
  <?php endswitch; ?>
</div>
